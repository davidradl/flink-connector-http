 ...
 * and a url of http://base. At lookup time with values of id1=1 and id2=2 a call of
 * http/base?id1=1&id2=2 will be issued.
 * <br>
 * For PUT and POST, parameters are mapped to the json body  e.g. for
 * REQUEST_PARAM_FIELDS = "id1;id2" and a url of http://base. At lookup time with values of id1=1 and
 ...
 * and a url of http://base/{key1}. At lookup time with values of col1="aaaa" a call of
...
public class GenericJsonAndUrlQueryCreator implements LookupQueryCreator {
    ...
    @VisibleForTesting
    static Row rowDataToRow(final RowData lookupDataRow, final DataType rowType) {
        Preconditions.checkNotNull(lookupDataRow);
        ...
        for (int idx = 0; idx < rowFields.size(); idx++) {
            ...
            final Object fieldValue = ((GenericRowData) lookupDataRow).getField(idx);
